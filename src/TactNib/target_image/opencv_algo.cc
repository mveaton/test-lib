...
namespace TactNib {
    ...
    //================================================
    Scalar OpencvAlgo::GetMSSIM(const Mat &i1, const Mat &i2)
    {
    ...
    //================================================
    Mat OpencvAlgo::AlignImageMotion(const Mat &im1, const Mat &im2)
    {
    ...
    //================================================
    Mat OpencvAlgo::FindBlob(const cv::Mat &source)
    {
        Mat source_keypoint;
    ...
    //================================================
    Mat OpencvAlgo::AdjustBrightness(const cv::Mat &source, const cv::Mat &target)
    {
        Image_Stat stat_source, stat_target;
        Mat source_hsv, target_hsv, target_bgr;
        ...
        stat_source = GetStat(source_hsv);
        stat_target = GetStat(target_hsv);
    ...
    //================================================
    TactNib::Image_Stat OpencvAlgo::GetStat(const Mat &src)
    {
        Image_Stat stat;
        Mat channels[3];
